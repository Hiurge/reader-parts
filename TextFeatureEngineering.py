...
# Generates all text features INSIDE A FRAME(!).
# - Contains separate run(self, mode) function to load simplified or specifiead mode to lower computation costs.

# General fix into:
# - add None/empty closures (!)
